...
<body>
        ...
        <div class="cards_continer">
            ...
            foreach($rows as $r)
            {
                ...
                echo '<h3 class="car_name_res">'.$r['name']. ' ' .$r['type'].'</h3>';
                echo '</div>';
                echo ' <div class="card_info_res">';
    ...
    <div class="form_container" id="reservation">

        <h2 class="form_title">ZAREZERWUJ SWOJE AUTO!</h2>

        <div class="form_fields">
            
        <form action="reserve.php" method="POST">
                <input type="text" class="form_name_surname" name="name" id="name" placeholder="Podaj Imię" required>
                <input type="text" class="form_name_surname" name="surname" id="surname" placeholder="Podaj Nazwisko" required>
                <input type="text" class="form_data" name="phone_number" id="phone_number" placeholder="Podaj numer telefonu" required>
                <input type="text" class="form_data" name="email_adress" id="email_adress" placeholder="Podaj adres email" required>
                <select name="form_choose_car" class="form_data" id="auto" required>
                            <option value="" disabled selected>Wybierz Model auta</option>
                            <?php
                ...
                <input type="datetime-local"  name="take_date_form" id="take_date_form" placeholder="Dzień pobrania auta" required>
                <input type="datetime-local"  name="back_date_form" id="back_date_form" placeholder="Dzień zwrotu auta" required>
                <!-- <input type="time"  name="back_hours_form" id="back_hours_form" placeholder="Wprowadź godzinę zwrotu" required> -->
                
                <input type="submit" class="butt_form2" value="ZAREZERWUJ">
            </form>
        </div>
    </div>
